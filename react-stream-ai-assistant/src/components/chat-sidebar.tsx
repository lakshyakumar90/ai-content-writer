...
export const ChatSidebar = ({
  ...
  const { section, channelId } = useParams<{ section?: string; channelId?: string }>();
          ...
          <div className="p-4 space-y-0">
            <ChannelList
              ...
              Preview={(previewProps) => {
                const isCurrentlyActive = channelId === previewProps.channel.id;
                return (
                  <div
                    className={cn(
        ...
        <div className="p-2 border-t">
          <Button
            ...
            className={cn(
              ...
              !channelId && (section === undefined || section === "writing") ? "bg-muted" : ""
            )}
            variant={!channelId && (section === undefined || section === "writing") ? "secondary" : "default"}
          >
          ...
          <div className="mt-2 grid grid-cols-1 gap-2">
            <Button
              variant={section === "images" ? "secondary" : "outline"}
              className={cn(
                "w-full justify-start",
                section === "images" ? "bg-muted" : ""
              )}
              onClick={() => {
            ...
            <Button
              variant={section === "resume" ? "secondary" : "outline"}
              className={cn(
                "w-full justify-start",
                section === "resume" ? "bg-muted" : ""
              )}
              onClick={() => {
                setActiveChannel(undefined);
